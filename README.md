...
- **Contas e Cartões**: controle de saldo, faturas por competência, pagamento de fatura, limite.
- **Categorias**: hierarquia categoria/subcategoria, com ícones e cores personalizáveis.
- **Orçamento**: planejamento mensal por categoria, comparado ao realizado.
- **Metas**: acompanhamento de objetivos financeiros com histórico de lançamentos vinculados.
- **Investimentos**: ativos, aportes e atualizações de valor.
- **Tags**: marcação livre de lançamentos, com contagem de uso.
- **Dashboard**: KPIs, gráfico de categorias, comparativo com o mês anterior, últimas transações.
...
Este projeto segue um changelog manual em [`CHANGELOG.md`](./CHANGELOG.md), com uma entrada por versão publicada. Cada versão relevante deve receber uma tag Git correspondente:
